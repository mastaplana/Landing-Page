...
if(window.Maitre === undefined || !Maitre.hasOwnProperty("uuid")) {
  div.innerHTML = 'Maitre Widget isn\'t configured properly.<br/>Please check the <a href="https://maitreapp.co/docs">Documentation</a>.';
	...
	var widget_assets = "https://maitreapp.co/widget_assets.js?v="+ new Date().getTime() +"&id="+Maitre.uuid+"&hosting_url="+Maitre.host;
	var url = window.location.href;
	var referral = /maitre-widget-referral=([^&]+)/.exec(url);
	var source = /maitre-widget-source=([^&]+)/.exec(url);
